...
% -> title of your work
\renewcommand{\title}{Solving PDEs using a Graph Neural Networks}
...
This part of the code refers to the second step of the pipeline, which is the solution of the variational problem. To this purpose we implemented a \texttt{Solver} class, which is located in the \texttt{DataGenerator.py} file in the \texttt{scripts} folder. The structure of the class is shown in Figure \ref{solver_class}. 
...
In the code \ref{solver} we show the definition of the parent class, with the abstract methods that are overridden in the child classes.
...
\begin{itemize}
    ...
    \item \texttt{set\_parameters(self)}: abstract method to set the problem parameters
    \item \texttt{solve(self)}: abstract method to solve the variational problem
    \item \texttt{plot\_solution(self)}: abstract method to plot the solution
\end{itemize}
...
\begin{itemize}
    ...
    \item \texttt{flux(self)}: abstract method for the computation of the flux at the interfaces
    \item \texttt{inlet\_flux(self)}: abstract method for the computation of the flux at the inlet
    ...
    \item \texttt{td\_nodes\_data(self)}: abstract method to save the time dependent nodes features.
...
\begin{figure}[H]
    \centering
    \subfloat[Decay of loss function over 300 epochs.]{\includegraphics[width=0.45\textwidth]{Images/loss.jpg}}
    \subfloat[Decay of metric function over 300 epochs.]{\includegraphics[width=0.45\textwidth]{Images/metric.jpg}}
...
\begin{figure}[H]
    \centering
    \subfloat[Heat flux at interface 1.]{\includegraphics[width=0.3\textwidth]{Images/train_node1_k59.76.png}}
    \subfloat[Heat flux at interface 2.]{\includegraphics[width=0.3\textwidth]{Images/train_node2_k59.76.png}}
    \subfloat[Heat flux at interface 3.]{\includegraphics[width=0.3\textwidth]{Images/train_node3_k59.76.png}}
...
\begin{figure}[H]
    \centering
    \subfloat[Heat flux at interface 1.]{\includegraphics[width=0.3\textwidth]{Images/test_node1_k99.66.png}}
    \subfloat[Heat flux at interface 2.]{\includegraphics[width=0.3\textwidth]{Images/test_node2_k99.66.png}}
    \subfloat[Heat flux at interface 3.]{\includegraphics[width=0.3\textwidth]{Images/test_node3_k99.66.png}}
...
\begin{figure}[H]
    \centering
    \subfloat[Heat flux at interface 1.]{\includegraphics[width=0.3\textwidth]{Images/new_node1_k3.05.png}}
    \subfloat[Heat flux at interface 2.]{\includegraphics[width=0.3\textwidth]{Images/new_node2_k3.05.png}}
    \subfloat[Heat flux at interface 3.]{\includegraphics[width=0.3\textwidth]{Images/new_node3_k3.05.png}}
...
\begin{figure}[H]
    \centering
    \subfloat[subcaption]{\includegraphics[width=0.3\textwidth]{Images/new_node1_k67.44.png}}
    \subfloat[subcaption]{\includegraphics[width=0.3\textwidth]{Images/new_node2_k67.44.png}}
    \subfloat[subcaption]{\includegraphics[width=0.3\textwidth]{Images/new_node3_k67.44.png}}
