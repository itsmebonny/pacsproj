...
Here we describe the instructions to run the whole code from data generation and testing of the network. For a more detailed description of the running instructions and the training of the model, please refer to the \texttt{README.md} file in the repository.
...
\begin{figure}[H]
    \centering
    \subfloat[Heat flux at interface 1.]{\includegraphics[width=0.3\textwidth]{Images/new_node1_k67.44.png}}
    \subfloat[Heat flux at interface 2.]{\includegraphics[width=0.3\textwidth]{Images/new_node2_k67.44.png}}
    \subfloat[Heat flux at interface 3.]{\includegraphics[width=0.3\textwidth]{Images/new_node3_k67.44.png}}
...
\begin{figure}[H]
    \centering
    \subfloat[Heat flux at interface 1.]{\includegraphics[width=0.3\textwidth]{Images/new_node1_k197.44.png}}
    \subfloat[Heat flux at interface 2.]{\includegraphics[width=0.3\textwidth]{Images/new_node2_k197.44.png}}
    \subfloat[Heat flux at interface 3.]{\includegraphics[width=0.3\textwidth]{Images/new_node3_k197.44.png}}
