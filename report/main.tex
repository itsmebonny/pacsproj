...
TODO: spiegare cosa abbiamo modificato nel codice originale (generalizzato a qualsiasi numero di output) 
...
As we can see from Figure \ref{}, the model is able to predict the heat flux at the interfaces with good accuracy when we test it on graphs from the training and the test set. 

\begin{figure}[H]
    \centering
    \subfloat[subcaption]{\includegraphics[width=0.3\textwidth]{Images/loss.jpg}}
    \subfloat[subcaption]{\includegraphics[width=0.3\textwidth]{Images/metric.jpg}}
    \subfloat[subcaption]{\includegraphics[width=0.3\textwidth]{Images/rollout.jpg}}
    \caption{Loss, metric and rollour error during the training.}
\end{figure}
