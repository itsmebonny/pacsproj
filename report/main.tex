...
% -> title of your work
\renewcommand{\title}{Solving PDEs using a Graph Neural Network}
...
\begin{figure}[H]
    \centering
    \subfloat[Decay of loss function over 500 epochs.]{\includegraphics[width=0.45\textwidth]{Images/loss.jpg}}
    \subfloat[Decay of metric function over 500 epochs.]{\includegraphics[width=0.45\textwidth]{Images/metric.jpg}}
