...
\begin{itemize}
    \item \textbf{scripts} This folder contains the scripts with all the classes and functions necessary to create the meshes, solve the variational problem and generate the graphs. 
    \item \textbf{gNN} This folder contains the code of the graph neural network.
    \item \textbf{notebooks} This folder contains the jupyter notebooks that can be run to generate the dataset and to test the GNN.
    \item \textbf{models} This folder contains the trained models.
    \item \textbf{README.md} This file contains a brief description of the repository and the instructions to run the code.
\end{itemize}
